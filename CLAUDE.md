...
npm run check      # tsx scripts/pruefen.ts — 163 checks, no test framework
npm run check:ui   # playwright test — 843 UI/a11y checks over three profiles (426 run, 417 skipped by profile), ~15 min (starts the dev server itself)
