...
export default function ManageModal({
  ...
  return (
    ...
    >
      <div
        ref={modalRef}
        className="bg-[var(--card-bg)] text-[var(--text-color)] rounded-2xl w-full max-w-xl max-h-[85vh] overflow-y-auto border border-[var(--border-color)] p-6 md:p-8 relative shadow-2xl"
      >
        {/* Close Button */}
        <button
          ref={closeButtonRef}
          type="button"
          onClick={onClose}
          aria-label="Formularverwaltung schließen"
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 id="manage-modal-title" className="text-2xl font-extrabold tracking-tight">
