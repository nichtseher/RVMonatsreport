...
export default function SecureBackupModal({ isOpen, onClose, onExport, onImport }: SecureBackupModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm" role="dialog" aria-modal="true" aria-labelledby="backup-title">
      <motion.div 
      ...
      >
        <div className="flex items-center justify-between p-4 md:p-6 border-b border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-slate-800/50">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-lg">
              <Lock className="w-5 h-5" aria-hidden="true" />
            </div>
            <h2 id="backup-title" className="text-xl md:text-2xl font-bold text-gray-900 dark:text-white">Datensicherung &amp; Backup</h2>
          </div>
          <button
            onClick={onClose}
            className="p-2 text-gray-500 hover:text-gray-700 hover:bg-gray-100 dark:hover:bg-slate-700 dark:text-gray-400 dark:hover:text-gray-200 rounded-full transition-colors focus:ring-2 focus:ring-blue-500 focus:outline-none"
