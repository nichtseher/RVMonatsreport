    ...
    >
      <div className="flex items-center justify-between gap-2 mb-3">
        <h2
          ...
          className="text-base font-extrabold tracking-tight text-[var(--text-color)] flex items-center gap-2"
        >
        ...
        <button
          ...
          className="px-2.5 py-1.5 rounded-lg text-xs font-bold border border-[var(--border-color)] bg-[var(--bg-color)] text-[var(--text-color)] hover:bg-[var(--border-color)] transition-all cursor-pointer flex items-center gap-1.5 active:scale-95"
        >
