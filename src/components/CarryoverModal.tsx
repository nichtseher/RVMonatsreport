...
export default function CarryoverModal({
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="carryover-modal-title"
    >
      <div
        ref={modalRef}
        className="bg-[var(--card-bg)] text-[var(--text-color)] rounded-2xl w-full max-w-lg border border-[var(--border-color)] p-6 md:p-8 relative shadow-2xl max-h-[90vh] overflow-y-auto"
      >
        {/* Close Button */}
        <button
          ref={closeButtonRef}
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <h2 id="carryover-modal-title" className="text-xl md:text-2xl font-black tracking-tight">
